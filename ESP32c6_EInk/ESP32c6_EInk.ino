...
GxEPD2_3C<GxEPD2_213_Z98c, GxEPD2_213_Z98c::HEIGHT> display(GxEPD2_213_Z98c(/*CS=5*/ 5, /*DC=*/ 1, /*RES=*/ 2, /*BUSY=*/ 3)); // GDEY0213Z98 122x250, SSD1680
...
void setup()
{
  ...
  {
    Serial.println("HALOANDREI este???");
    showPartialUpdate();
    delay(1000);
  }
  display.hibernate();
...
const char HelloWorld[] = "Hello World nigga!";
