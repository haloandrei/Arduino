...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    String message = "";
    if ( a == 1) message = "Autobuzul Str. Stefan Cel Mare - Moisan ajunge intr-un minut";
    if ( a == 2) message = "Autobuzul Viisoara - Unirea ajunge intr-un minut";
    if ( a == 3) message = "Autobuzul David - Mos Ion Roata si Unirea ajunge intr-un minut";
